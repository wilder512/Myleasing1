...
namespace MyleasingWeb.Data
{
    public class SeeDb
    {
        ...
        //mete los datos a la base de datos.. 
        ...
        {
            //garantiza que la base de datos este creada..  si no esta la crea 
        ...
        private async Task CheckOwnersAsync()
        {
            ...
            {
                AddOwner("8989898", "Juan", "Zuluaga", "Calleeeeee tulia ", "234 3232", "Calle Luna Calle Sol");
                AddOwner("7655544", "Jose", "Cardona", "lacacahdkjsbd ", "300 322 3221", "Calle 77 #22 21");
                AddOwner("6565555", "Maria", "López", "cdcdcdcdcdc ", "350 322 3221", "Carrera 56 #22 21");
                await _context.SaveChangesAsync();
            }
        }   
